...
classes = ['duck', 'fish']
data = ImageDataBunch.single_from_classes(None, classes, tfms=get_transforms(), size=224).normalize(imagenet_stats)
learner = create_cnn(data, models.resnet34)
learner.load('./duck-fish.pth')
